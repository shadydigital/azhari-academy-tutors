...
const applicationData = {
  ...
  teachingLanguages: [{ language: "ar", level: "native" }, { language: "en", level: "advanced" }],
  yearsExperience: "5",
  ...
  deviceOther: "",
  internet: "fiber",
  internetBackup: "mobile-data",
  teachingSpace: true,
  videoTools: ["Zoom", "Google Meet", "Screen sharing"],
  weeklyHours: "20",
  availability: [
    { day: "sunday", enabled: true, from: "16:00", to: "21:00" },
    { day: "monday", enabled: true, from: "16:00", to: "21:00" },
  ...
  videoUrl: "",
  links: [{ type: "cv", url: "https://drive.google.com/example" }],
